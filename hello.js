...
const AdminDashboard = () => {
 ...
 const {usersDoc}=useSelector((state) => state.adminAuth);
                                ...
                                currentUsers.map((user) => (
                                    <tr key={user._id}>
                                        ...
                                        <td>
                                            ...
                                            <button onClick={() => handleDeleteUser(user._id)} className="admin-delete-btn" style={{backgroundColor:'#080808'}}>Delete</button>
                                        </td>
                                    </tr>
                                ))
                            ) : (
